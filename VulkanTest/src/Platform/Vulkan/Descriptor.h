...
struct Descriptor
{
	...
	Descriptor(VkDescriptorType descriptorType, VkShaderStageFlagBits shaderFlags, VkBufferUsageFlagBits usageFlags, size_t bufferSize, std::function<bool(AppVulkanImpl*, void*)> updateFunc)
	...
	Descriptor(VkDescriptorType descriptorType, VkShaderStageFlagBits shaderFlags, VkBufferUsageFlagBits usageFlags, int bufferCount, size_t bufferSize, std::function<bool(AppVulkanImpl*, void*)> updateFunc)
	...
	Descriptor(VkDescriptorType descriptorType, VkShaderStageFlagBits shaderFlags, VkBufferUsageFlagBits usageFlags, int bufferCount, size_t bufferSize, std::function<bool(AppVulkanImpl*, void*)> updateFunc, VkMemoryPropertyFlagBits propertyFlags);
	...
	std::function<bool(AppVulkanImpl*, void*)> bufferUpdateFunc;
